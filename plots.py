...
RESULTS_PATH = '/home/gohu/workspace/postdoc/decstr/decstr_gangstr/output/'
SAVE_PATH = '/home/gohu/workspace/postdoc/decstr/decstr_gangstr/plots/'
TO_PLOT = ['comparison_reward_learned_and_original_GANGSTR']#'Architecture', 'Rewards', 'Masks', 'Partial']
...
if __name__ == '__main__':
    ...
    for PLOT in TO_PLOT:
        ...
        conditions = ['original_run', 'reward_func_learned_v1']
        labels = ['GANGSTR', 'GANGSTR + learned reward']
        get_mean_sr(experiment_path, max_len, max_seeds, conditions, labels, ref='original_run')
