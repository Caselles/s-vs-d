...
if __name__ == '__main__':
    num_eval = 1
    #path = '/home/gohu/workspace/postdoc/decstr/decstr_gangstr/output/GANGSTR_ORIGINAL/2021-10-04 17:38:51_FetchManipulate3Objects-v0_gnn_per_object/models/'
    '''path = '/media/gohu/backup_data/postdoc/gangstr_predicates_instructions/output/2022-01-07 12:36:50_FetchManipulate3Objects-v0_gnn_per_object_NAIVE_TEACHER_FOR_FINETUNING_70%_PEDAGOGICAL_SR/models/'
    model_path = path + 'model_150.pt'''
    '''#path = '/home/gohu/workspace/postdoc/decstr/gangstr_teacher/gangstr_predicates_instructions/output/2021-12-17 10:48:18_FetchManipulate3Objects-v0_gnn_per_object_PEDAGOGICAL_CHEAT/models/'
    #model_path = path + 'model_200.pt'''

    #path = '/media/gohu/backup_data/postdoc/gangstr_predicates_instructions/output/2022-01-10 16:52:14_FetchManipulate3Objects-v0_gnn_per_object_PEDAGOGICAL_TEACHER_95%_PEDAGOGICAL_SR/models/'
    path = '/media/gohu/backup_data/postdoc/gangstr_predicates_instructions/output/2022-01-11 17:01:34_FetchManipulate3Objects-v0_gnn_per_object/models/'
