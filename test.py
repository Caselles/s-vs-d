...
if __name__ == '__main__':
    ...
    #path = '/home/gohu/workspace/postdoc/decstr/gangstr_teacher/gangstr_predicates_instructions/output/2021-12-20 17:31:25_FetchManipulate3Objects-v0_gnn_per_object_NAIVE_TEACHER/models/'
    ...
    if illustrative_example:
        ...
        proba_goals = eval_goals.copy()
        # the trick is that the initialization will gave 0 close to 1 already


    for i in range(num_eval):
        episodes = rollout_worker.generate_rollout(eval_goals, eval_masks, self_eval=True, true_eval=True, biased_init=True, animated=False, 
