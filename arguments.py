...
def get_args():
    ...
    # the reward function arguments
    parser.add_argument('--architecture-reward-func', type=str, default='flat', help='Architecture of the reward function module')
    parser.add_argument('--lr-reward-func', type=float, default=0.001, help='the learning rate of the reward function module')
    parser.add_argument('--n-batches_reward', type=int, default=50, help='the times to update the reward network')
