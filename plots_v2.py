...
RESULTS_PATH = '/media/gohu/backup_data/postdoc/gangstr_predicates_instructions/plots/goal_pred_sqil_naive_pragmaticpedagogic_rewarddemos7rewardexpnormal/'
SAVE_PATH = '/media/gohu/backup_data/postdoc/gangstr_predicates_instructions/plots/goal_pred_sqil_naive_pragmaticpedagogic_rewarddemos7rewardexpnormal/'
TO_PLOT = ['comparison_pedagogical_naive_teacher_sqil_learner']#'Architecture', 'Rewards', 'Masks', 'Partial']
...
if __name__ == '__main__':
    ...
    for PLOT in TO_PLOT:
        ...
        conditions = ['naiveliteral', 'pragmaticpedagogic']
        labels = ['Naive', 'Pedagogical']
        get_mean_sr(experiment_path, max_len, max_seeds, conditions, labels, ref='naiveliteral')
